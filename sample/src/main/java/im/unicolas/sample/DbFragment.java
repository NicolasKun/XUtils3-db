...
import im.xutils.common.util.KeyValue;
import im.xutils.db.sqlite.WhereBuilder;
import im.xutils.db.table.DbModel;
import im.xutils.ex.DbException;

import im.unicolas.sample.db.Child;
import im.unicolas.sample.db.Parent;
import im.xutils.x;
...
public class DbFragment extends Fragment {
    ...
    private void init(View view) {
        ...
        btnTestDb = (Button) view.findViewById(R.id.btn_test_db);
        btnTestDb2 = (Button) view.findViewById(R.id.btn_test_db2);
        ...
        btnTestDb2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onTestDb2Click(v);
            }
